...
#+end_src
* alacritty
#+BEGIN_SRC conf :tangle ./alacritty/alacritty.yml :mkdirp yes
window:
...
#+END_SRC
* bspwm
#+BEGIN_SRC shell :tangle ./bspwm/bspwmrc :mkdirp yes
#!/bin/sh
...
#+END_SRC
* sxhkd
#+BEGIN_SRC conf :tangle ./sxhkd/sxhkdrc :mkdirp yes
#
...
#+END_SRC
* dunst
#+begin_src conf :tangle ./dunst/dunstrc :mkdirp yes
[global]
    monitor = 0
    follow = mouse
    width = 350
...
* polybar
** theme config
#+begin_src conf :tangle ./polybar/config :mkdirp yes
[colors]
...
#+end_src
** launch config
#+begin_src shell :tangle ./polybar/launch.sh :mkdirp yes
#!/bin/sh

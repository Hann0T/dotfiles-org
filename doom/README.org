...
(defun ligth-theme () (interactive "set the theme to dark theme")
  (load-theme 'doom-ayu-light t))
(defun dark-theme () (interactive "set the theme to dark theme")
  (load-theme 'doom-one t))

(defun start-nyan-mode () (interactive)
   (setq nyan-mode t
    (setq nyan-toggle-wavy-trail t)
   (setq nyan-animate-nyancat t)))
(defun stop-nyan-mode () (interactive)
   (setq nyan-toggle-wavy-trail nil
...
;;(global-set-key (kbd "C-d") '(lambda () (interactive) (evil-scroll-down) (evil-scroll-line-to-center)))
;;(global-set-key (kbd "C-u") '(lambda () (interactive) (evil-scroll-down) (evil-scroll-line-to-center)))
#+END_SRC
*** rust config
#+BEGIN_SRC emacs-lisp :tangle ~/.doom.d/config.el
